...
function Footer() {
  return (
    <div className='flex flex-col w-full  bg-Primary pt-[40px] pb-[20px] px-[20px] gap-[40px]'>
      <div className='flex flex-col gap-[60px]'>
      <div className='flex flex-col gap-[20px] '>
        <div className=' w-[238.89px]'>
          <img src={logo} alt='logo' className='w-full h-full' />
        </div>
        <p className='text-white font-lato text-[16px] font-light  leading-[19px] w-[330px]'>Your goal is our target. Not anything in between. We use online marketing platforms and tools to achieve single objective - your business results.</p>
