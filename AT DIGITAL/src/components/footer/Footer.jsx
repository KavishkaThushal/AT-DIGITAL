...
function Footer() {
  return (
    <div className='flex flex-col w-full  mt-[60px] bg-Primary pt-[40px] pb-[20px] px-[20px] gap-[40px] md:px-[40px] lg:px-[60px]  '>
      <div className='flex flex-col gap-[60px] lg:flex-row justify-between '>
      <div className='flex flex-col gap-[20px] '>
        <div className=' w-[238.89px] '>
          <img src={logo} alt='logo' className='w-full h-full' />
        </div>
        <p className='text-white font-lato text-[16px] font-light  leading-[19.2px] w-[330px] md:w-[400px]'>Your goal is our target. Not anything in between. We use online marketing platforms and tools to achieve single objective - your business results.</p>

      </div>

      <div className='flex flex-col gap-[40px] md:gap-[116px] md:flex-row lg:gap-[96px] xl:gap-[146px]'>
      ...
      <hr className=' w-[335px] mx-auto md:w-[630px]'/>
